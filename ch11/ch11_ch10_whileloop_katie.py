# -*- coding: utf-8 -*-
"""
Created on Tue Dec 18 11:39:10 2018

@author: Katharina
"""

def addAnotherClassMate(phoneBook, counter):
    option = 'Y'
    while option == 'Y' and counter < 5:
        print('Would you like to add another class mate? Y/N' )
        option = input()
        phoneBook = addClassMate(phoneBook, counter)
    choosingWhatToDo(phoneBook)


def addClassMate(phoneBook, counter):
    ...
    counter += 1
    addAnotherClassMate(phoneBook, counter)
    return phoneBook

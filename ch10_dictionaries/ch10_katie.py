...
@author: Katharina
"""
#task1: Create a dictionary, assign and update values 
...
#task2: Create a dictionary  
tel = {'hien' : '111', 'harriet' : 989}
print(tel['harriet'])

#
#task3 : Look up/ Update 
...
#task4:keys and values
print(tel.keys())
print(tel.values())

#task5: Converting keys and values in list data type 
#KEYS

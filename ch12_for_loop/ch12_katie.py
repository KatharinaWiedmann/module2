...
###Exercise6: Create a salary dicitionary and Loop through a dictionary

##6.1: SALARY DICTIONARY 
salary = {'al': 20000, 'bo': 50000, 'ced': 1500}
salary_in_order = sorted(salary.items(), key = lambda s:s[1], reverse = True)

for each in salary_in_order:
    print(each[0], each[1])

### 6.2 PERSONAL NOTES: PLAYING WITH METAL DICTIONARY 
